...
export class TableCenter {
   ...
   public galaxyDiscard: InstanceType<typeof BgaCards.Deck<Card>>;
   ...
   constructor(private game: Game) {
      ...
      this.galaxyDiscard = new BgaCards.Deck<Card>(game.cardManager, document.querySelector(".deck-discard-pile")!, {
