...
final class GainResourceChoice implements Choice {
    private int $amount;
    ...
    {
        $message = clienttranslate('${player_name} chooses to gain ${value} Resource(s)');
        $ctx->currentPlayer()->addResources($this->amount, $message);
    }
}